SELECT L.mun, L.zone, L.brgy, L.purok, DC.calamity_desc,
...
GROUP BY L.mun, L.zone, L.brgy, L.purok, DC.calamity_desc WITH ROLLUP
...
WHERE L.location_id = C.location_id
AND L.location_id = TOTAL.location_id
GROUP BY DC.calamity_desc, L.mun, L.zone, L.brgy, L.purok WITH ROLLUP
...
WHERE L.location_id = C.location_id
AND L.location_id = TOTAL.location_id
GROUP BY L.purok, DC.calamity_desc, L.mun, L.zone, L.brgy WITH ROLLUP
...
WHERE L.location_id = C.location_id
AND L.location_id = TOTAL.location_id
GROUP BY L.brgy, L.purok, DC.calamity_desc, L.mun, L.zone WITH ROLLUP
...
WHERE L.location_id = C.location_id
AND L.location_id = TOTAL.location_id
GROUP BY  L.zone, L.brgy, L.purok, DC.calamity_desc, L.mun WITH ROLLUP