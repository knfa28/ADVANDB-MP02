...
public class QueryDrilldown1 {
    ...
    public QueryDrilldown1(int location_id, String house_type, String tenur_type, int hh_count, float roof_avg, float wall_avg, float water_avg, float welec_avg) {
