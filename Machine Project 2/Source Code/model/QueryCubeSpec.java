...
public class QueryCubeSpec {
    ...
    public QueryCubeSpec(int mun, int zone, int brgy, int purok, String calamity_type, float frequency_sum, float aid_avg, float strong_avg, float weak_avg, float others_avg) {
        this.mun = mun;
        this.zone = zone;
        this.brgy = brgy;
        this.purok = purok;
